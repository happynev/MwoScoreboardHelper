 ...
 */
public class QuickplaySummaryOffsets_16_10 extends Offsets {
    private final static int WIDTH = 3840;
    private final static int HEIGHT = 2400;

    private final static int FIRST_PLAYERLINE_OFFSET = 481;
    ...
    private final static int IDENT_OFFSET_Y = 2170;
    ...
    private static final int TEAM_OFFSET_WINNER = 826;
    private static final int TEAM_OFFSET_LOSER = 1500;
    ...
    public QuickplaySummaryOffsets_16_10(BufferedImage img) {
        this(img.getWidth(), img.getHeight());
    }

    public QuickplaySummaryOffsets_16_10(int width, int height) {
        this(getScaleFactor(width, height, WIDTH, HEIGHT));
    }

    public QuickplaySummaryOffsets_16_10(double scale) {
        scaleFactor = scale;
    }
