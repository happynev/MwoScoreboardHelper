 ...
 */
public class QuickplayRewardsOffsets_16_9 extends Offsets {
    ...
    private final static int IDENT_OFFSET_Y = 361;
    ...
    private static final int REWARD_Y = 476;
    ...
    private static final int PERF_FIRSTLINE_Y = 510;
    ...
    public QuickplayRewardsOffsets_16_9(BufferedImage img) {
        this(img.getWidth(), img.getHeight());
    }

    public QuickplayRewardsOffsets_16_9(int width, int height) {
        this(getScaleFactor(width, height, WIDTH, HEIGHT));
    }

    public QuickplayRewardsOffsets_16_9(double scale) {
        scaleFactor = scale;
    }
    ...
    protected Offsets getScaledInstance(int width, int height) {
        return new QuickplayRewardsOffsets_16_9(width, height);
    }
